...
window.onload=function () {
    ...
    var app = new Vue({
        ...
        methods: {
            ...
            //查询总用户数量
            countUserSum: function () {
                axios.get("/user/countUserSum.do").then(function (response) {
                    //vue把数据列表包装在data属性中
                    app.userSum = response.data;
                    app.countActiveUser();
                }).catch(function (err) {
                    console.log(err);
                });
            ...
            countActiveUser: function () {
                axios.get("/user/countActiveUser.do").then(function (response) {
                    //vue把数据列表包装在data属性中
                    app.activeUser = response.data;
                    app.inactiveUser = app.userSum - app.activeUser;
                }).catch(function (err) {
                    console.log(err);
                });
            }
